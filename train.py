...
#                           workspace=ws)
        ...
        # end epoch ----------------------------------------------------------------------------------------------------
        mmodel = MModel.register(model_path='outputs/yolov5/runs/train/exp/weights/best.pt',model_name="best_yolo_v5_model",tags={'area': "Ades_project_1st_phase_v3", 'type': "object detection"},description="object detection for all safety violations",workspace=ws)
